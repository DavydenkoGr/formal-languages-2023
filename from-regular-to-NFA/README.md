...
Поиск подслова аналогично eps переходам O(k * кол-во ребер), чтобы асимптотика не ломалась при больших k,
достаточно искать слова длины min(k, кол-во вершин + 1). Тогда асимптотика будет O(n^2).
